...
Vagrant.configure("2") do |config|
  ...
  # config.vm.synced_folder "recording-validation-interface/", "/app"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    apt-get update
    apt-get upgrade -y
    apt-get install -y git python2.7 python-dev libxml2-dev libxslt1-dev zlib1g-dev python-pip python-virtualenv nodejs apache2 libapache2-mod-wsgi
    a2enmod proxy
    a2enmod proxy_http
    a2enmod alias
